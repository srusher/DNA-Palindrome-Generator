...
public class hwk3_1 {
    ...
    public static void main(String[] args){
        ...
        codongen.codon2aa(codongen.dnaseq); //calling codon2aa() method from the DNA class, with the dnaseq field as the parameter -- Identical to method above, except it will also print the character code for the amino acid below each codon
