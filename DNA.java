...
public class DNA {
    ...
    public static void codon(String dna){ //creating codon() method which accepts a string parameter

        System.out.println("\nThe DNA sequence is:\n"+dna); //printing original dna sequence

        //The segment below will find orf1

        double count = 0; //creating count variable
        ...
        System.out.print("\nReading Frame #1 codons are:\n"+orf1+"\n"); //printing orf1 with appropriate message
        ...
        System.out.print("\nReading Frame #2 codons are:\n"+orf2+"\n"); //printing orf2 with appropriate message
        ...
        System.out.print("\nReading Frame #3 codons are:\n"+orf3+"\n"); //printing orf3 with appropriate message
    ...
    public static void codon2aa(String dna){ //creating codon2aa method -- this method a modified version of the method above
        ...
        //same as orf1 loop in codon() method above -- the segment for converting the codons to amino acids is after the first print statement
        ...
        //same as orf2 loop in codon() method above -- the segment for converting the codons to amino acids is after the first print statement
        ...
        //same as orf3 loop in codon() method above -- the segment for converting the codons to amino acids is after the first print statement below
